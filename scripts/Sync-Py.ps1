...
# ? Install the `softboiler_github_io_tools` Python module
...
if ($Compile) {
    ...
    $comp_low = softboiler_github_io_tools compile
    $comp_high = softboiler_github_io_tools compile --high
    ...
    $comp = softboiler_github_io_tools get-comp --high=$High
...
if ($Lock) {
    ...
    softboiler_github_io_tools lock
...
if (!$NoPostSync) {
    ...
    softboiler_github_io_tools 'sync-local-dev-configs'
